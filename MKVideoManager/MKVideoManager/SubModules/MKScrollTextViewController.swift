...
class MKScrollTextViewController: UIViewController {
	...
	func setupData() {
		for index in 0...19 {
			...
			let contentLabel: UILabel = UILabel(frame: CGRect(x: 0, y: offsetY, width: 321, height: self.cellHeight))
		...
		self.scrollView.contentSize = CGSize(width: 321, height: height)
	}
