...
class MKQuestionStickerView: UIView {
	...
	func setSubViews() {
		...
		let contentView = UIView.init(frame: CGRect.init(x: 0, y: 0, width: 300, height: 94))
		contentView.layer.cornerRadius = 12
		contentView.backgroundColor = UIColor.white
		self.addSubview(contentView)
		
		sendButton = UIButton.init(frame: CGRect.init(x: 0, y: 0, width: 300, height: 48))
		...
		ownerIconImageView = UIImageView.init(frame: CGRect.init(x: 0, y: 0, width: 32, height: 30))
		...
		questionTextView = MKPlaceholderTextView.init(frame: CGRect.init(x: 0, y: 0, width: 200, height: 32))
		...
		questionTextView.placeholderColor = UIColor.init(white: 0, alpha: 0.5)
		questionTextView.font = UIFont.systemFont(ofSize: 17, weight: UIFont.Weight.medium)
		questionTextView.textColor = UIColor.init(white: 0, alpha: 1)
		...
		answerContentView = UIView.init(frame: CGRect.init(x: 0, y: 0, width: 300, height: 32))
		contentView.addSubview(answerContentView)
		answerContentView.layer.cornerRadius = 10
		answerContentView.backgroundColor = UIColor.init(white: 0, alpha: 0.06)
		...
		answerTextView = MKPlaceholderTextView.init(frame: CGRect.init(x: 0, y: 0, width: 300, height: 30))
		...
		answerTextView.placeholderColor = UIColor.init(white: 0, alpha: 0.35)
		answerTextView.font = UIFont.systemFont(ofSize: 13, weight: UIFont.Weight.regular)
		answerTextView.textColor = UIColor.init(white: 0, alpha: 0.75)
