...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DPScrollNumberLabel/DPScrollNumberLabel.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/JTNumberScrollAnimatedView/JTNumberScrollAnimatedView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MBProgressHUD/MBProgressHUD.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MJRefresh/MJRefresh.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/NumberScrollAnimatedView/NumberScrollAnimatedView.framework"
